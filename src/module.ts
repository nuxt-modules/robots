...
export default defineNuxtModule<ModuleOptions>({
  ...
  interface NitroRuntimeHooks {
    ...
    'robots:robots-txt': (ctx: import('${typesPath}').HookRobotsTxtContext) => void | Promise<void>
        ...
        const isNuxt4 = Number(data.nuxt?.options.future?.compatibilityVersion) === 4
...
declare module 'h3' {
  interface H3EventContext {
    robots: import('${typesPath}').RobotsContext
    robotsProduction?: import('${typesPath}').RobotsContext
  }
}
