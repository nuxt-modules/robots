...
relatedPages:
  - path: /docs/robots/advanced/i18n
    title: Nuxt I18n
...
**Disabling the Nuxt Content integration.** If you need to disable it, you can do so by setting the `disableNuxtContentIntegration`{lang="ts"} option in the module configuration.
