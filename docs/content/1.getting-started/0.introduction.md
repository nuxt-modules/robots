...
relatedPages:
  ...
  - path: /docs/sitemap/getting-started/introduction
    title: Nuxt Sitemap
...
Control how search engines and AI crawlers interact with your Nuxt site using robots.txt, meta tags, and X-Robots-Tag headers. Nuxt Robots provides minimal config with best practice defaults.
...
The module uses [Nuxt Site Config](/docs/site-config/getting-started/introduction) to determine if the site is in production mode.
...
Will automatically fix any non-localized paths within your `allow` and `disallow` rules.
