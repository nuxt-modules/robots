...
Its major update to v3.0.0 shouldn't have any direct effect on your site, however, you may want to double-check
...
When configuring robots using route rules or [Nuxt Content](/docs/robots/advanced/content) you could control the robot's behavior by providing `index` or `indexable` rules.
...
**Config `blockAiBots`.** AI crawlers can be beneficial as they can help users find your site, but for some educational sites or those not
