...
## `autoI18n: boolean | AutoI18nConfig`{lang="ts"}
...
See [const-bots.ts](https://github.com/nuxt-modules/robots/blob/main/src/const-bots.ts) for the list of bots that are blocked.
