...
relatedPages:
  - path: /docs/robots/api/use-bot-detection
...
The modern web is full of [bots](/learn-seo/nuxt/controlling-crawlers). Start detecting them to better understand your traffic and optimize your Nuxt app for both human users and automated agents.
...
[View and contribute to bot definitions →](https://github.com/nuxt-modules/robots/blob/main/src/const.ts)
